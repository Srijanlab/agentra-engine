...
class MemoryIssuesMixin:
    """Mixin for Memory: bug filing, discovery, dedup, and failure triage.
    Assumes self._repo_url() is defined on the base class."""
    ...
    def record_failure(self, run_id: str, step_name: str, text: str, severity: str = "high") -> None:
        ...
        # A step-name-only diagnosis is identical across every distinct failure of that step, so
        # any later similarity-based match against this field carries no real signal.
