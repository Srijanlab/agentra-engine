...
def _tools_for(session: OrchestratorSession) -> list:
    ...
    async def implement_feature(args):
        ...
        if tracking_issue is not None:
            ...
            registry.record_run(session.run_id, loop_id=_loop_id, issue_number=str(tracking_issue))
