...
App-agnostic by design: everything here is plain JSON/YAML files agentos
...
brain.py) -- agentos's own code never talks to Firestore/Postgres/anything
...
class Memory:
    ...
    # ── Signals: production issues, from agentos's own monitoring (debug-prod) ──
    ...
    # optional; `agentos objective set/show` manages this file directly. ──────
